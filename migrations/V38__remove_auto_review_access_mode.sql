...
CREATE TABLE sessions_v38 (
    ...
    access_mode TEXT NOT NULL DEFAULT 'default'
        CHECK (access_mode IN ('default', 'full_access')),
...
DROP TABLE sessions;
ALTER TABLE sessions_v38 RENAME TO sessions;
...
VALUES (38, 'remove_auto_review_access_mode');
