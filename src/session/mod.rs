...
pub use model::{
    ...
    LoadedSessionStatus, LoadedSessionSummary, MessageMetadata, MessagePart, MessageRecord,
    MessageRole, NewMessage, NewPart, NewSession, PartKind, PartRecord, ProjectRecord,
    PromptDispatchPart, ReasoningPart, RepairControlSnapshotDiagnostic, RepairIntentDiagnostic,
    RepairLaneDiagnostic, RepairOperationTemplate, RepairRecoveryChoiceDiagnostic,
