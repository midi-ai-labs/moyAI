...
pub(crate) fn python_test_module_content_has_executable_shape(target: &str, content: &str) -> bool {
    ...
    has_test_definition && has_test_context && !test_target_has_invalid_test_class_base(&executable)
}
