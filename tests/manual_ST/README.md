...
- `case5_2`: case5 の調査結果を引き継ぎ、restart-safe / idempotent cancellationを設計・実装し、app再起動後の回帰修正まで行うStage 1〜4の比較benchmarkと、同じownerのSide Chatから長い履歴を問い合わせる独立Stage 5
